...
func main() {
	...
	fmt.Println("=== Lock-Free Optimization Test ===")
	fmt.Println("Testing consistent hashing with high concurrency\n")
	
	// Test with consistent hashing
	...
	workerCounts := []int{10, 25, 50, 100, 200}
	totalOps := 20000
